const socialLinks = [
    {
        href: 'https://www.github.com/adriel-babalola',
    ...
    {
        href: 'https://www.linkedin.com/in/adriel-babalola',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://x.com/AdrielBaba57136',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://www.instagram.com/adriel.127',
        ...
        >
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <div className="flex gap-2 item mt-auto">
                        {
                ...
                <form
                    action="https://www.formbackend.com/f/f1382a7fe6cee043"
                    method="POST"
                ...
                >
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                placeholder="adrielbabalola@gmail.com"
                                className="text-field reveal-up"
                            />
                        </div>
                    </div>
                    ...
                    <button
                        type="submit"
                        className="btn btn-primary w-full !max-w-full flex items-center justify-center reveal-up"
                    >
                        Submit
                    </button>
                </form>
